  ...
  expect(callLepusMethodCalls).toMatchInlineSnapshot(`
    [
      [
        "rLynxChange",
        {
          "data": "{"patchList":[{"snapshotPatch":[0,"__Card__:__snapshot_a6614_test_4",2,4,2,[1],0,null,3,4,3,[0],1,2,3,null,1,-1,2,null],"id":2}]}",
          "patchOptions": {
            "isHydration": true,
            "pipelineOptions": {
              "dsl": "reactLynx",
        ...
        "children": [
          {
            ...
            "extraProps": undefined,
            "id": 2,
            "type": "__Card__:__snapshot_a6614_test_4",
            "values": [
              "2:0:",
            ],
          },
