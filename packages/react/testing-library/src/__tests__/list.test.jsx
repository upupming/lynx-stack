    ...
    expect(container).toMatchInlineSnapshot(`
      <page>
        <list
          custom-list-name="list-container"
          style="height: 700rpx; width: 700rpx; background-color: #f0f0f0;"
          update-list-info="[{"insertAction":[{"position":0,"type":"__Card__:__snapshot_f24e5_test_22","item-key":"0"},{"position":1,"type":"__Card__:__snapshot_f24e5_test_22","item-key":"1"},{"position":2,"type":"__Card__:__snapshot_f24e5_test_22","item-key":"2"}],"removeAction":[],"updateAction":[]}]"
        />
      </page>
    `);
