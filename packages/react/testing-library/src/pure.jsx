...
export function render(
  ...
  globalThis.lynxTestingEnvironment.switchToMainThread();
  __root.__jsx = enableMainThread ? compMainThread : null;
  renderPage();
  if (enableBackgroundThread) {
    globalThis.lynxTestingEnvironment.switchToBackgroundThread();
    act(() => {
  ...
  return {
    container: lynxTestingEnvironment.mainThread.elementTree.root,
    unmount: cleanup,
    rerender: (rerenderUi) => {
      lynxTestingEnvironment.reset();
    ...
    ...getQueriesForElement(lynxTestingEnvironment.mainThread.elementTree.root, queries),
  };
}
...
export function cleanup() {
  ...
  lynxTestingEnvironment.mainThread.elementTree.root = undefined;
  clearPage();
  lynxTestingEnvironment.jsdom.window.document.body.innerHTML = '';
