...
test('.toBeDisabled', () => {
  ...
  expect(() => expect(queryByTestId('button-element')).not.toBeDisabled())
    .toThrowError();
  ...
  expect(() => expect(queryByTestId('a-element')).toBeDisabled())
    .toThrowError();
  expect(() => expect(queryByTestId('deep-a-element')).toBeDisabled())
    .toThrowError();
});
...
test('.toBeEnabled', () => {
  ...
  expect(() => expect(queryByTestId('a-element')).not.toBeEnabled())
    .toThrowError();
  expect(queryByTestId('deep-a-element')).toBeEnabled();
  expect(() => expect(queryByTestId('deep-a-element')).not.toBeEnabled())
    .toThrowError();
});
