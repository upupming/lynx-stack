...
describe('.toBeInvalid', () => {
  test('handles <input/>', () => {
    ...
    expect(() => expect(queryByTestId('no-aria-invalid')).toBeInvalid())
      .toThrowError();
    expect(() => expect(queryByTestId('aria-invalid')).not.toBeInvalid())
      .toThrowError();
    expect(() => expect(queryByTestId('aria-invalid-value')).not.toBeInvalid())
      .toThrowError();
    expect(() => expect(queryByTestId('aria-invalid-false')).toBeInvalid())
      .toThrowError();
...
describe('.toBeValid', () => {
  test('handles <input/>', () => {
    ...
    // negative test cases wrapped in throwError assertions for coverage.
    expect(() => expect(queryByTestId('no-aria-invalid')).not.toBeValid())
      .toThrowError();
    expect(() => expect(queryByTestId('aria-invalid')).toBeValid())
      .toThrowError();
    expect(() => expect(queryByTestId('aria-invalid-value')).toBeValid())
      .toThrowError();
    expect(() => expect(queryByTestId('aria-invalid-false')).not.toBeValid())
      .toThrowError();
