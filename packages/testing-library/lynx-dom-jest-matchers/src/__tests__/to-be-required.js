...
test('.toBeRequired', () => {
  ...
  expect(() => expect(queryByTestId('required-input')).not.toBeRequired())
    .toThrowError();
  ...
  expect(() => expect(queryByTestId('conflicted-input')).not.toBeRequired())
    .toThrowError();
  expect(() => expect(queryByTestId('not-required-input')).toBeRequired())
    .toThrowError();
  expect(() => expect(queryByTestId('basic-input')).toBeRequired())
    .toThrowError();
  expect(() => expect(queryByTestId('unsupported-type')).toBeRequired())
    .toThrowError();
  expect(() => expect(queryByTestId('select')).not.toBeRequired())
    .toThrowError();
  expect(() => expect(queryByTestId('textarea')).not.toBeRequired())
    .toThrowError();
  expect(() => expect(queryByTestId('supported-role')).toBeRequired())
    .toThrowError();
  expect(() => expect(queryByTestId('supported-role-aria')).not.toBeRequired())
    .toThrowError();
});
