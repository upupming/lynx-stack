...
test('.toHaveClass', () => {
  ...
  expect(() => expect(queryByTestId('delete-button')).not.toHaveClass('btn'))
    .toThrowError();
  expect(() =>
    expect(queryByTestId('delete-button')).not.toHaveClass('btn-danger')
  ).toThrowError();
  expect(() => expect(queryByTestId('delete-button')).not.toHaveClass('extra'))
    .toThrowError();
  expect(() => expect(queryByTestId('delete-button')).toHaveClass('xtra'))
    .toThrowError();
  expect(() =>
  ...
  expect(() => expect(queryByTestId('delete-button')).toHaveClass('btn-link'))
    .toThrowError();
  expect(() => expect(queryByTestId('cancel-button')).toHaveClass('btn-danger'))
    .toThrowError();
  expect(() => expect(queryByTestId('svg-spinner')).not.toHaveClass('spinner'))
    .toThrowError();
  expect(() => expect(queryByTestId('svg-spinner')).toHaveClass('wise'))
    .toThrowError();
  ...
  expect(() => expect(queryByTestId('delete-button')).not.toHaveClass())
    .toThrowError(/(none)/);
  expect(() => expect(queryByTestId('delete-button')).not.toHaveClass('  '))
    .toThrowError(/(none)/);
});
...
test('.toHaveClass with regular expressions', () => {
  ...
  expect(() => expect(queryByTestId('delete-button')).not.toHaveClass(/danger/))
    .toThrowError();

  expect(() => expect(queryByTestId('delete-button')).toHaveClass(/dangerous/))
    .toThrowError();
});
