...
describe('.toHaveTextContent', () => {
  ...
  test('handles text nodes', () => {
    ...
    `);
    expect(elementTree.root.children[0].children[0]).toHaveTextContent(
      'example',
    );
  });
  ...
  test('when matching with empty string and element with content, suggest using toBeEmptyLynxFiberElement instead', () => {
    const page = __CreatePage('0', 0);
    const text0 = __CreateText(0);
