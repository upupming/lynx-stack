        ...
        "children": [
          {
            "children": undefined,
            "id": 2,
            "type": "__Card__:__snapshot_f696a_test_1",
            "values": undefined,
          },
        ],
        "id": -1,
  ...
  expect(callLepusMethod.mock.calls).toMatchInlineSnapshot(`
    [
      [
        "rLynxChange",
        {
          "data": "{"snapshotPatch":[0,"__Card__:__snapshot_f696a_test_1",2,1,-1,2,null]}",
          "patchOptions": {
            "commitTaskId": 2,
            "isHydration": true,
            "pipelineOptions": {
      ...
      [
        "rLynxChange",
        {
          "data": "{"snapshotPatch":[2,-1,2,0,"__Card__:__snapshot_f696a_test_2",3,0,null,4,3,4,0,"Hello World",1,3,4,null,1,-1,3,null]}",
          "patchOptions": {
            "commitTaskId": 3,
            "pipelineOptions": {
              "needTimestamps": true,
