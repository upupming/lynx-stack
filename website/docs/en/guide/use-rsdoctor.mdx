...
After running the above commands, Rspeedy will automatically register the Rsdoctor plugin, and after the build is completed, it will open the build analysis page. For complete features, please refer to [Rsdoctor document](https://rsdoctor.rs/).

## Options

If you need to configure the [options](https://rsdoctor.rs/config/options/options#options) provided by the Rsdoctor plugin, use [`tools.rsdoctor`](../api/rspeedy.tools.rsdoctor.md).
